...
class DbUtil {
    ...
    renameFolder = async(folderID, userID, title) => {
        const folder = await Folder.findOneAndUpdate({ _id: new ObjectID(folderID), owner: userID }, { $set: { name: title } });
    ...
    moveFolder = async(folderID, userID, parent, parentList) => {
        const folder = await Folder.findOneAndUpdate({ _id: new ObjectID(folderID), owner: userID }, { $set: { parent: parent, parentList: parentList } });
