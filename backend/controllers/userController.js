...
class UserController {
    ...
    verifyEmail = catchAsyncErrors(async(req, res, next) => {
    ...
    resendVerifyEmail = catchAsyncErrors(async(req, res, next) => {
        const { _id } = req.user;
        console.log(_id);
    ...
    // Change Password
    changePassword = catchAsyncErrors(async(req, res, next) => {
    ...
    // Forget Password
    forgetPassword = catchAsyncErrors(async(req, res, next) => {
